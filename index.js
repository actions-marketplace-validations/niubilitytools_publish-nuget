...
class Action {
      ...
      .get(`${this.nugetSource}/v3-flatcontainer/${this.packageName}/index.json`, (res) => {
        ...
        if (res.statusCode == 200) {
          ...
          res.on('end', () => {
            ...
            else console.log('Found the version ' + this.version + ' on the ' + this.nugetSource)
          })
        }
      })
      .on('error', (e) => {
  ...
  run() {
    if (!this.projectFile || !fs.existsSync(this.projectFile)) this._printError('project file not found')
